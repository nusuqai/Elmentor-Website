  ...
  en: [
    {
      ...
      rating: 4.9,
      reviews: 124,
      tags: ["Product Strategy", "Roadmapping", "PM Coaching"],
      badge: "Top Mentor",
      sex: "female",
    },
    {
      ...
      rating: 4.9,
      reviews: 98,
      tags: ["Leadership", "Team Management", "Career Growth"],
      sex: "male",
    },
    {
      id: "mentor_004",
      ...
      rating: 5.0,
      reviews: 76,
      tags: ["UX Strategy", "Portfolio Review", "Design Career"],
      sex: "female",
    },
  ],
  ar: [
    {
      id: "mentor_001",
      name: "مايا السيد",
      title: "مديرة منتج في سبوتيفاي",
      exp: 8,
      rating: 4.9,
      reviews: 124,
      tags: ["استراتيجية المنتج", "خارطة الطريق", "تدريب PM"],
      badge: "أفضل موجه",
      sex: "female",
    },
    {
      id: "mentor_002",
      name: "عمر خالد",
      title: "مدير هندسة البرمجيات",
      exp: 11,
      rating: 4.9,
      reviews: 98,
      tags: ["القيادة", "إدارة الفرق", "النمو المهني"],
      sex: "male",
    },
    {
      id: "mentor_004",
      name: "لينا فوزي",
      title: "مصممة أولى لتجربة المستخدم",
      exp: 4,
      rating: 5.0,
      reviews: 76,
      tags: ["استراتيجية UX", "مراجعة البورتفوليو", "التصميم المهني"],
      sex: "female",
    },
  ],
};
  ...
  en: [
    {
      ...
      quote:
        "Maya helped me transition into product management with a clear roadmap and real-world advice.",
      mentorId: "mentor_001",
      sex: "female",
    },
    {
      ...
      quote:
        "Omar's guidance was instrumental in my promotion to Engineering Manager.",
      mentorId: "mentor_002",
      sex: "male",
    },
    {
      ...
      role: "UX Designer",
      quote:
        "Lina's feedback on my portfolio and interview prep was a game changer.",
      mentorId: "mentor_004",
      sex: "female",
    },
  ],
  ar: [
    {
      ...
      role: "مديرة منتج",
      quote:
        "ساعدتني مايا في الانتقال إلى إدارة المنتجات بخارطة طريق واضحة ونصائح واقعية ممتازة.",
      mentorId: "mentor_001",
      sex: "female",
    },
    {
      ...
      role: "مدير هندسي",
      quote:
        "كانت توجيهات عمر حاسمة ومحورية للغاية في ترقيتي إلى رتبة مدير هندسة البرمجيات.",
      mentorId: "mentor_002",
      sex: "male",
    },
    {
      ...
      role: "مصممة UX",
      quote:
        "كانت تعليقات لينا على البورتفوليو الخاص بي والاستعداد للمقابلات نقطة تحول حقيقية ومفصلية في مسيرتي.",
      mentorId: "mentor_004",
      sex: "female",
    },
  ],
    ...
    <section className="relative bg-white pt-[88px]">
      ...
      <div className="max-w-[1280px] mx-auto px-6 lg:px-10 py-6 lg:py-16">
        ...
        >
          {/* ═══ LEFT COLUMN ═══ */}
          <div
            className={`flex-1 flex flex-col justify-center max-w-[560px] ${
          ...
          >
            ...
            {/* Stats */}
            <div
              className={`flex flex-wrap gap-x-8 gap-y-4 pt-8 border-t border-border/60 ${
                lang === "ar" ? "flex-row-reverse" : ""
              }`}
            >
              {t.hero.stats.map((s, i) => (
                ...
                >
                  <p className="text-[24px] font-bold text-navy-base leading-none">
                    {s.value}
                  </p>
          ...
          <div className="flex-1 flex flex-col gap-6 max-w-[600px]">
            ...
            <div className="bg-white rounded-2xl border border-border shadow-card p-6">
              <h2
                className="text-[20px] font-bold text-navy-base mb-1"
                style={{ textAlign: lang === "ar" ? "right" : "left" }}
              >
                {t.hero.searchCardTitle}
              </h2>
              <p
                className="text-[14px] text-text-muted mb-5"
                style={{ textAlign: lang === "ar" ? "right" : "left" }}
              >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
                <div className="flex flex-col">
                  <span
                    className="text-[11px] text-text-muted font-medium mb-1"
                    style={{ textAlign: lang === "ar" ? "right" : "left" }}
                  >
                    {t.hero.goalLabel}
                  </span>
              ...
              {featured.map((m) => (
                ...
                >
                  <div className="relative h-[120px] md:h-[140px] overflow-hidden">
                    ...
                    {m.badge && (
                      <div
                        className={`absolute top-2 bg-teal text-white text-[9px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wide ${
                  ...
                  >
                    <p
                      className={`text-[13px] font-semibold text-navy-base leading-tight flex items-center gap-1 ${
                        lang === "ar" ? "flex-row-reverse" : ""
                      }`}
                    >
                      {m.name}
                    ...
                    <div
                      className={`flex items-center gap-1 mt-2 text-[11px] text-text-secondary ${
                        lang === "ar" ? "flex-row-reverse" : ""
                      }`}
                    >
                      ...
                      <span>
                        {m.exp} {lang === "ar" ? "سنة خبرة" : "yrs exp."}
                      </span>
                    </div>
                    <div
                    ...
                    >
                      {m.tags.slice(0, 2).map((t, j) => (
                        <span
                          key={j}
                          className="text-[9px] font-medium text-text-muted bg-surface px-1.5 py-0.5 rounded"
                        >
                          {t}
                        </span>
                      ))}
        ...
        <div className="max-w-[1280px] mx-auto px-6 lg:px-10 py-6">
          ...
          >
            {testimonials.map((t, i) => (
              <div
                key={i}
                className={`flex gap-3 ${lang === "ar" ? "flex-row-reverse text-right" : "text-left"}`}
              >
                <Image
                  src={MENTOR_PHOTOS[t.sex]}
                  alt={t.name}
                  width={40}
                  height={40}
