...
export const LogoMark: React.FC<IconProps> = ({ size = 32, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" {...props}>
    {/* Left person – navy */}
    <circle cx="16" cy="8" r="4" fill="#0A243F" />
    <path d="M6 32c0-8 4-14 10-16 6 2 10 8 10 16" stroke="#0A243F" strokeWidth="3.5" strokeLinecap="round" fill="none" />
    {/* Right person – teal */}
    <circle cx="32" cy="8" r="4" fill="#077F7F" />
    <path d="M22 32c0-8 4-14 10-16 6 2 10 8 10 16" stroke="#077F7F" strokeWidth="3.5" strokeLinecap="round" fill="none" />
    {/* Sparkle */}
    <path d="M24 22l1.5 3 3 1.5-3 1.5L24 31l-1.5-3-3-1.5 3-1.5z" fill="#5226FF" />
  </svg>
);
...
export const MessageCircleIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const BriefcaseIcon: React.FC<IconProps> = ({ size = 16, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
